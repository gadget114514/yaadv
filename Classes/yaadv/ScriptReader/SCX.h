...
namespace yaadv {
  ...
  class SCCharacterSpeak : public ScriptCommand {
   public:
    ...
    SCCharacterSpeak(ScriptReader *reader, std::string &name,
  ...
  class SCIf : public ScriptCommand {
   ...
   public:
    SCIf(ScriptReader *reader, std::string expression, std::string trueTag,
         std::string falseTag);
    ~SCIf();
    void execute(cocos2d::Node *stage);
  ...
  class SCImg : public ScriptCommand {
   public:
    ...
    SCImg(ScriptReader *reader, std::string &name, std::string &loc,
          std::string &face);
    ~SCImg();
    void execute(cocos2d::Node *stage);
  };
  ...
  class SCImgTween : public ScriptCommand {
   public:
    ...
    float _duration;
    SCImgTween(ScriptReader *reader, std::string &name, std::string &loc,
               float dur, std::string &ease, std::string &face);
    ~SCImgTween();
    void execute(cocos2d::Node *stage);
  };
